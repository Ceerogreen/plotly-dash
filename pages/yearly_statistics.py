...
# %%
SliderMarks={ # Create slider marks, make all either black or invisible
...
layout = html.Div([
    ...
    html.Div(children = [# Contain row with radio and dropdowns
        ...
        html.Div(children = [
            dcc.Dropdown( # Create Second Dropdown
                id = 'FourFactors2',
                options = FourFactors,
                value = 'EFG%D'
            )
...
def update_Graph1a(radio_value,slider_value):
    ...
    if radio_value == 'Bart Torvik':
        fig = px.scatter(year_data, # Scatter year data with BartTorvik stats
            ...
            hover_data = {'BADJ O': False,
                          ...
                          'SEED': True,
                          'Round Made': True},
            title= str(slider_value) + ' ' + radio_value + ' Efficiency Matrix'
        )
    ...
    fig.update_layout(title_x=0.5, plot_bgcolor='#D3D3D3', paper_bgcolor='#D3D3D3') # Match formatting
    return fig
...
def update_Graph1b(x_dropdown,y_dropdown,slider_value):
    ...
    fig = px.scatter(year_data, # Scatter requested x and y data
                     ...
                     hover_data = {x_dropdown: False,
                                ...
                                'SEED': True,
                                'Round Made':True}, 
                     title = x_dropdown + ' vs. ' + y_dropdown + ' in ' + str(slider_value)
                                )
